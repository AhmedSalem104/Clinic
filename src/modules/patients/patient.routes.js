...
router.get('/:id', requireAnyPermission(PERMISSIONS.VIEW_ALL_PATIENTS, PERMISSIONS.VIEW_ASSIGNED_PATIENTS), asyncHandler(controller.getById));
...
router.get('/:id/assignments', requireAnyPermission(PERMISSIONS.VIEW_ALL_PATIENTS, PERMISSIONS.VIEW_ASSIGNED_PATIENTS), asyncHandler(controller.assignments));
